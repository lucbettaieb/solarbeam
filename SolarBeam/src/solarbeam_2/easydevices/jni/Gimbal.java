...
public class Gimbal {
    ...
    public native void setMotorSpeed(long gimbalPointer, long highspeed, long lowspeed, long accelerate, int select);
    ...
    public native long getMotorSpeedHighspeed(long gimbalPointer, int select);
